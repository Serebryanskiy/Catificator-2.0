...
public class MainActivity extends AppCompatActivity {
    ...
    private CatsClassifier catsClassifier;
    ...
    private void loadCatsClassifier() {
        try {
            catsClassifier = CatsClassifier.classifier(getAssets(), CatsModelConfig.MODEL_FILENAME);
        } catch (IOException e) {
            Toast.makeText(this, "Cats model couldn't be loaded. Check logs for details.", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
    ...
    private void onImageCaptured(byte[] picture) {
        ...
        List<Classification> recognitions = catsClassifier.recognizeImage(preprocessedImage);
